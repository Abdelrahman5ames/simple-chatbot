...
python chatbot.py
🗣️ Usage
Start the chatbot: Execute the Python script to initiate the bot.
Interact with the chatbot: Type your questions or statements.
Get responses: The chatbot will reply based on pre-established rules and keywords.
🚀 Future Enhancements
